...
export const registerMeshiTools = (
  ...
  server.registerTool(
    ...
    async (args) => {
      ...
      // eslint-disable-next-line no-restricted-syntax -- orchestrator.recordFromText() already converts its own failures into result.error rather than rejecting; this only guards against a genuinely unexpected throw before it reaches the MCP SDK unhandled
      try {
  ...
  server.registerTool(
    ...
    async (args) => {
      ...
      // eslint-disable-next-line no-restricted-syntax -- orchestrator.recordFromImage() already converts its own failures into result.error rather than rejecting; this only guards against a genuinely unexpected throw before it reaches the MCP SDK unhandled
      try {
  ...
  server.registerTool(
    ...
    async (args) => {
      ...
      // eslint-disable-next-line no-restricted-syntax -- orchestrator.queryMeals() already converts its own failures into result.error rather than rejecting; this only guards against a genuinely unexpected throw before it reaches the MCP SDK unhandled
      try {
  ...
  server.registerTool(
    ...
    async (args) => {
      ...
      // eslint-disable-next-line no-restricted-syntax -- orchestrator.recommendMeal() already converts its own failures into result.error rather than rejecting; this only guards against a genuinely unexpected throw before it reaches the MCP SDK unhandled
      try {
